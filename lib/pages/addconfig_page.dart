        ...
        child: Column(
          children: <Widget>[
            ...
            CustomFiledWidget(
              ...
              initialValue: (newConfig.model.value.intervalSecond ?? 0).toString(),
            ),
            CustomFiledWidget(
              label: "Skew Second",
              onChanged: newConfig.setSkewSecond,
              keyboardType: TextInputType.number,
              initialValue: (newConfig.model.value.skewSecond ?? 0).toString(),
            ),
            CustomFiledWidget(
              label: "Sni",
            ...
            CustomFiledWidget(
              ...
              keyboardType: TextInputType.number,
              initialValue: (newConfig.model.value.readDeadlineSecond ?? 0).toString(),
            ),
            CustomFiledWidget(
              ...
              keyboardType: TextInputType.number,
              initialValue:
                  (newConfig.model.value.writeDeadlineSecond ?? 0).toString(),
            ),
            CustomFiledWidget(
              label: "Min Split Packet",
              onChanged: newConfig.setMinSplitPacket,
              keyboardType: TextInputType.number,
              initialValue: (newConfig.model.value.minSplitPacket ?? 0).toString(),
            ),
            CustomFiledWidget(
              label: "Max Split Packet",
              onChanged: newConfig.setMaxSplitPacket,
              keyboardType: TextInputType.number,
              initialValue: (newConfig.model.value.maxSplitPacket ?? 0).toString(),
            ),
            CustomFiledWidget(
              label: "Padding",
              onChanged: newConfig.setPadding,
              keyboardType: TextInputType.number,
              initialValue: (newConfig.model.value.padding ?? 0).toString(),
            ),
            CustomFiledWidget(
              label: "SubChunk",
              onChanged: newConfig.setSubChunk,
              keyboardType: TextInputType.number,
              initialValue: (newConfig.model.value.subChunk ?? 0).toString(),
            ),
            const SizedBox(
              height: 15,
            ),
